...
/* Navigation List */
let Startup_NavigationList_Array_Titles = ["Control Panel"]; //Launcher navigation text
let Startup_NavigationList_Array_Links = ["GG_Controls.html"]; //Launcher navigation links
let Startup_NavigationList_Array_Icons = ["favicon_old.png"];


/* App Default Page Properties */
var pageProperty_MenuName = "Game Graphics"; // Refers to the name displayed on the main menu
...
function Startup_Load_Properties(){
    ...
    switch(App_CurrentPageName){
        ...
        break;
		case "GG_Controls.html":
            pageProperty_pageIcon = "ContentByElmerF.png";
            pageProperty_MenuName = "Control Panel";
            pageProperty_PageTitle = "Control Panel";
			...
			pageProperty_enableFullContainerMode = 0;
        break;
		case "GG_Screen_1_Title.html":
            pageProperty_pageIcon = "ContentByElmerF.png";
            pageProperty_MenuName = "Title Screen";
            pageProperty_PageTitle = "Title Screen";
            pageProperty_enableGreetings = 0;
